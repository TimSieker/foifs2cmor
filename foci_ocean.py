...
def _fix_coordinates(cube, var, definition, base_time="1850-01-01"):
    """Fix coordinates."""
...
def _extract_variable(in_files, var, cfg, out_struc):
    ...
    cube = _fix_coordinates(cube, var, definition, base_time=attributes['base_time'])
...
def _save_variable(cube, var_name, out_struc, var_attr, **kwargs):
    ...
    **kwargs: kwargs
    ...
    print('Finished cmorizing variable ' + var_name)
...
def _fixer_script(filepath, var_name, var_attr):
    ...
    with Dataset(filepath, 'r+') as ds:
        ...
        #print(ds.variables[var_name].chunking())


        """ds.renameDimension(u'bnds_4',u'vertices')
        ds.renameVariable(u'lat_bnds', u'vertices_latitude')
        ds.renameVariable(u'lon_bnds', u'vertices_longitude')

        ds['lat'].missing_values = 1e20
        ds['lon'].missing_values = 1e20
        ds['vertices_latitude'].missing_values = 1e20
        ds['vertices_longitude'].missing_values = 1e20

        #ds['lat']._FillValue = 1e20
        #ds['lon']._FillValue = 1e20
        #ds['vertices_latitude']._FillValue = 1e20
        #ds['vertices_longitude']._FillValue = 1e20"""
